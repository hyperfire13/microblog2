                    ...
                    <div class="card border-default" style="margin-top: 29px;">
                      <div class="card-body" ng-show="retweet.deleted">
                        ...
                        <div ng-show="retweet.images.length > 0">
                          <div class="row">
                            <div class="col-md-4" ng-repeat="n in [].constructor(retweet.images.length)  track by $index">
                              <figure>
                                <img  id="postPic" ng-src="pic-posts/{{retweet.images[$index]}}" alt="">
                                <figcaption><i>{{retweet.image_captions[$index]}}</i></figcaption>
                              </figure>
                            </div>
                          </div>
                        </div>
